...
const CrudTest = ({ navigation, theme }) => {
  ...
  const { gameData, CheckSave, setGameData, playerRoom, setPlayerRoom, enemyRoom, setenemyRoom, playerHealth, setPlayerHealth, checkSave, setCheckSave, saveGame, clearSave  } = useContext(GameContext);
  const { colors } = theme;
